var as1 = BEZIER(S0)([[-8,15,0],[-8,-15,0]]);
var as2 = BEZIER(S0)([[8,15,0],[8,-15,0]]);

var dd = PROD1x1([INTERVALS(1)(14),INTERVALS(1)(20)]);

var as3 = COLOR([0.4,0.4,0.4,1])(MAP(BEZIER(S1)([as1,as2]))(dd));

//DRAW(as3);

var as4 = COLOR([1,1,1,1])(S([0,1,2])([1/20,1/20,1/20])(as3));
var as5 = T([1,2])([14,0.001])(as4);

var as6 = REPLICA(15)([as5,T([1])([-2])]);
var righe = STRUCT(as6);
var airstrip = STRUCT([as3,righe]);
...
var aaa5 = COLOR([0.30,0.30,0.30,1])(STRUCT([aa1,aa2]));
var ali = STRUCT([aaa5,assi]);



var aer = STRUCT([fusoliera,timt,ali]);
var aer1 = R([1,2])(-PI/10)(aer);
var aereo = T([2])([3.15])(aer1);

var model = STRUCT([aereo,airstrip]);
DRAW(model);
